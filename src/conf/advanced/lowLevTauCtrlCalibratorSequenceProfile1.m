...
left_arm_seqParams.labels = {...
    ...
    'NA'     ,'NA'     ,'pos'                ,'vel'           ,'joint'    ,'jtorq'    ,'pwm'     ,'jtorq';...
...
left_leg_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{3}     ,repmat( 4,[1 6]),false      ,false      ,0        ,false;...
    promptStr,'pwmctrl',homeCalib.val{3}     ,repmat( 4,[1 6]),true       ,true       ,0        ,true};
...
torso_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{5}     ,repmat( 4,[1 3]),false      ,false      ,0        ,false;...
    promptStr,'pwmctrl',homeCalib.val{5}     ,repmat( 4,[1 3]),true       ,true       ,0        ,true};
...
head_seqParams.val = {...
    NA       ,'ctrl'   ,homeCalib.val{6}     ,repmat( 4,[1 3]),false      ,false      ,0        ,false;...
    promptStr,'pwmctrl',homeCalib.val{6}     ,repmat( 4,[1 3]),true       ,true       ,0        ,true};
